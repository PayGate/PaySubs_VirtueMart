# PaySubs_VirtueMart
## PayGate PaySubs1 (VCS) VirtueMart plugin v1.0.0 for VirtueMart v3.8.10

This is the PayGate PaySubs (VCS) plugin for VirtueMart. Please feel free to contact the PayGate support team at support@paygate.co.za should you require any assistance.

## Installation
Please navigate to the [releases page](https://github.com/PayGate/PaySubs_VirtueMart/releases), download the latest release (v1.0) and unzip. You will then be able to follow the integration guide which is included in the zip.
